    ...
    <div class="container-fluid px-4">
        ...
        <div class="collapse navbar-collapse justify-content-start px-2" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-black px-3 py-0" href="{{route('caregiver')}}">Hire Caregivers</a> 
                </li>
                <li class="nav-item">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-center align-items-center ms-3">
            <a href="{{ route('register') }}" class="btn btn-outline-dark rounded-pill mb-2 mb-md-0 me-md-2">Sign up</a>
            <a href="{{ route('login') }}" class="btn btn-dark rounded-pill">Log in</a>
        </div>
        @endauth
    </div>
</nav>
